...
public class TraThuoc_PDFExporter {
    ...
    public static void exportPhieuTraThuocToPdf(PhieuDoiTra pdt, List<CTPhieuDoiTra> dsCT, String filePath) {
        ...
        try {
            ...
            Paragraph header = new Paragraph("PHIẾU TRẢ THUỐC", fontTitle);
            ...
            Paragraph total = new Paragraph("TỔNG TIỀN HOÀN LẠI: " + df.format(pdt.getTienHoanLai()), fontBold);
            total.setAlignment(Element.ALIGN_RIGHT);
            document.add(total);

            document.close();
            JOptionPane.showMessageDialog(null, "Xuất phiếu trả thuốc PDF thành công!");
        } catch (Exception e) {
            e.printStackTrace();
