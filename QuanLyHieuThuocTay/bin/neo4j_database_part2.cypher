...
// ============================================================
CREATE (t:Thuoc {maThuoc: 'T01', tenThuoc: 'Paracetamol 500mg', giaNhap: 1500, giaBan: 3000, soLuong: 200, hanSuDung: '2027-06-15', thanhPhan: 'Paracetamol', donViTinh: 'Viên', anh: 'img/anhthuoc/Paracetamol500mg.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T02', tenThuoc: 'Amoxicillin 500mg', giaNhap: 2000, giaBan: 4500, soLuong: 150, hanSuDung: '2027-03-20', thanhPhan: 'Amoxicillin trihydrate', donViTinh: 'Viên', anh: 'img/anhthuoc/Amoxicillin500mg.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T03', tenThuoc: 'Vitamin C 1000mg', giaNhap: 3000, giaBan: 6000, soLuong: 300, hanSuDung: '2027-12-01', thanhPhan: 'Acid ascorbic', donViTinh: 'Viên', anh: 'img/anhthuoc/VitaminC500mg.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T04', tenThuoc: 'Thuốc ho Bảo Thanh', giaNhap: 15000, giaBan: 28000, soLuong: 80, hanSuDung: '2027-09-10', thanhPhan: 'Mật ong, tỳ bà diệp', donViTinh: 'Chai', anh: 'img/anhthuoc/SirohoAstex.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T05', tenThuoc: 'Omeprazol 20mg', giaNhap: 1800, giaBan: 4000, soLuong: 120, hanSuDung: '2027-05-25', thanhPhan: 'Omeprazol', donViTinh: 'Viên', anh: 'img/anhthuoc/Phosphalugel.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T06', tenThuoc: 'Ibuprofen 400mg', giaNhap: 1200, giaBan: 2500, soLuong: 250, hanSuDung: '2027-08-30', thanhPhan: 'Ibuprofen', donViTinh: 'Viên', anh: 'img/anhthuoc/Ibuprofen400mg.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T07', tenThuoc: 'Cetirizin 10mg', giaNhap: 800, giaBan: 2000, soLuong: 180, hanSuDung: '2027-04-18', thanhPhan: 'Cetirizin dihydrochlorid', donViTinh: 'Viên', anh: 'img/anhthuoc/Cetirizin10mg.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T08', tenThuoc: 'Amlodipine 5mg', giaNhap: 2500, giaBan: 5000, soLuong: 100, hanSuDung: '2027-07-22', thanhPhan: 'Amlodipine besilat', donViTinh: 'Viên', anh: 'img/anhthuoc/Concor5mg.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T09', tenThuoc: 'Kem bôi Gentrisone', giaNhap: 18000, giaBan: 35000, soLuong: 60, hanSuDung: '2027-02-14', thanhPhan: 'Gentamicin, Clotrimazol', donViTinh: 'Tuýp', anh: 'img/anhthuoc/Bepanthen.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T10', tenThuoc: 'Nhỏ mắt Natri Clorid 0.9%', giaNhap: 5000, giaBan: 10000, soLuong: 90, hanSuDung: '2027-01-05', thanhPhan: 'Natri clorid', donViTinh: 'Lọ', anh: 'img/anhthuoc/nautamine.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T11', tenThuoc: 'Azithromycin 250mg', giaNhap: 3500, giaBan: 7000, soLuong: 130, hanSuDung: '2027-11-11', thanhPhan: 'Azithromycin', donViTinh: 'Viên', anh: 'img/anhthuoc/Azithromycin500mg.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T12', tenThuoc: 'Multivitamin Centrum', giaNhap: 5000, giaBan: 9500, soLuong: 200, hanSuDung: '2028-01-15', thanhPhan: 'Vitamin A,B,C,D,E, khoáng chất', donViTinh: 'Viên', anh: 'img/anhthuoc/Pharmaton.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T13', tenThuoc: 'Thuốc cảm Tiffy', giaNhap: 1000, giaBan: 2200, soLuong: 300, hanSuDung: '2027-10-20', thanhPhan: 'Paracetamol, Chlorpheniramine', donViTinh: 'Viên', anh: 'img/anhthuoc/Tiffy.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T14', tenThuoc: 'Smecta', giaNhap: 4000, giaBan: 8000, soLuong: 70, hanSuDung: '2027-06-30', thanhPhan: 'Diosmectite', donViTinh: 'Gói', anh: 'img/anhthuoc/Smecta.jpg', trangThai: 'Đang kinh doanh'});
CREATE (t:Thuoc {maThuoc: 'T15', tenThuoc: 'Aspirin 81mg', giaNhap: 900, giaBan: 2000, soLuong: 5, hanSuDung: '2026-06-10', thanhPhan: 'Acid acetylsalicylic', donViTinh: 'Viên', anh: 'img/anhthuoc/Aspirin81mg.jpg', trangThai: 'Đang kinh doanh'});
